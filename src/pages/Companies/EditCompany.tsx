...
export const EditCompany: FC = () => {
  ...
  useEffect(() => {
    ...
    if (companyById) {
      formik.setValues({
        id: companyById.id,
        company_name: companyById.company_name || "",
        trade_name: companyById.trade_name || "",
        address: companyById.address || "",
        contact: companyById.contact || "",
        phone: companyById.phone || "",
        business_type: companyById.business_type || "",
        date_of_incorporation: companyById.date_of_incorporation || "",
        state_of_incorporation: companyById.state_of_incorporation || "",
        federal_tax_id: companyById.federal_tax_id || "",
        duns_no: companyById.duns_no || "",
        sic_code: companyById.sic_code || "",
        years_in_business: companyById.years_in_business || "",
        website: companyById.website || "",
        primary_contact: companyById.primary_contact || "",
        email: companyById.email || "",
        invoicing_address: companyById.invoicing_address || "",
        invoicing_contact: companyById.invoicing_contact || "",
        invoicing_email: companyById.invoicing_email || "",
        invoicing_city: companyById.invoicing_city || "",
        invoicing_state: companyById.invoicing_state || "",
        invoicing_zip: companyById.invoicing_zip || "",
        invoicing_fax: companyById.invoicing_fax || "",
        payment_method: companyById.payment_method || "",
        purchasing_contact: companyById.purchasing_contact || "",
        purchasing_phone: companyById.purchasing_phone || "",
        purchasing_email: companyById.purchasing_email || "",
        owner_name: companyById.owner_name || "",
        owner_position: companyById.owner_position || "",
        owner_ownership: companyById.owner_ownership || "",
        owner_address: companyById.owner_address || "",
        owner_phone: companyById.owner_phone || "",
        owner_email: companyById.owner_email || "",
        bank_name: companyById.bank_name || "",
        bank_number: companyById.bank_number || "",
        bank_contact: companyById.bank_contact || "",
        bank_phone: companyById.bank_phone || "",
        bank_email: companyById.bank_email || "",
        bank_address: companyById.bank_address || "",
        credit_first_name: companyById.credit_first_name || "",
        credit_contact: companyById.credit_contact || "",
        credit_phone: companyById.credit_phone || "",
